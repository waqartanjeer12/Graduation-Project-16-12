...
namespace ECommerceInfrastructure.Migrations
{
    ...
    [Migration("20250123182621_withOrderTable")]
    partial class withOrderTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceCore.Models.Shipping", b =>
                {
                    b.Property<int>("ShippingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("totalPriceBeforeShipping")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ECommerceCore.Models.Order", b =>
                {
                    b.HasOne("ECommerceCore.Models.Shipping", "Shipping")
                        .WithOne("Order")
                        .HasForeignKey("ECommerceCore.Models.Order", "ShippingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
